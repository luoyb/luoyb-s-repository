/**
 * @(#)ReflectionUtils.java 2009-12-8
 * 
...
import cc.cnfc.core.exception.ExceptionUtil;

/**
 * 反射的Util函数集合.
 * 
 * 提供访问私有变量,获取泛型类型Class,提取集合中元素的属性,转换字符串到对象等Util函数. import from springside3
 * 
 * @author fwgroup
 * @date 2009-12-8
 * @version $Revision$
...
public class ReflectionUtil {
	 ...
	 */
	public static void setProperty(final Object object, final String fieldName, final Object value) {
		try {
	...
	public static RuntimeException convertReflectionExceptionToUnchecked(Exception e) {
		return ExceptionUtil.convertCheckedExceptionToUnchecked(e);
	}
}
