...
public class Md5 {
	...
	public static void main(String args[]) throws IOException {
		try {
			Md5 md5 = new Md5("");
			//	      System.out.println(md5.encodeByMd5("20050705-801-93000260.0TLCC200511019398000005LCCcNcARd)%!&(*pICc" ));
			md5.hmac_Md5("PEDA201135020592A000012", "Picc123456Ticket");
	...
	private static byte padding[] = { (byte) 0x80, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0, (byte) 0,
	...
	public static String encodeByMd5(String s) {
		try {
			...
			md.reset();
			byte cryptbyte[] = md.digest(s.getBytes("utf-8"));
	 ...
	 * @return
	 */
	public static String encodeByMd5(String s, String type) {
		try {
			MessageDigest md = MessageDigest.getInstance("Md5");
			md.reset();
			if (type == null) {
				...
				byte cryptbyte[] = md.digest(s.getBytes(type));
				return byteToString(cryptbyte);
			}
		} catch (Exception e) {
			// TODO: handle exception
