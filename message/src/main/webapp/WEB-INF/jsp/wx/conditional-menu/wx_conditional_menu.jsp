...
<div class="page-content">
	...
	<div class="page-header">
		<div class="alert alert-warning">
			<a class="btn btn-danger" href="${ctx}/wxMenu/toWxConditionalMenuRuleList.do">返回</a>
			<span style="padding-left:20px;">菜单标示名：${wxMenuMatchRule.ruleName}</span>
			<span style="padding-left:20px;">适用用户分组：${wxMenuMatchRule.groupId}</span>
		</div>
		<!-- <h1>
			微信个性化菜单
			<small>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form action="${ctx}/wxMenu/saveWxDefaultMenu.do" method="post" id="form-wx-conditional-menu" enctype="multipart/form-data">
				<button type="button" class="btn btn-success btn-block" id="btn-save-wx-conditional-menu">保存</button>
			</form>
			<!-- PAGE CONTENT ENDS -->
		</div><!-- /.col -->
	</div><!-- /.row -->
