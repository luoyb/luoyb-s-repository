	...
	jQuery(function($) {
		...
		*/
		...
		jQuery(grid_selector).jqGrid({
			...
			datatype: "json",
			height: 250,
			colNames:['手机号','内容','发送时间','发送状态'],
			colModel:[
				{name:'mobile',index:'mobile',width:200, editable:false},
				{name:'content',index:'content',width:200, editable:false},
				{name:'sendTime',index:'sendTime', width:200,editable: false},
